<?php 
	...
	if (isset($_POST['save'])) {
		...
		if (empty($err)) { 
			$sql = "INSERT INTO mahasiswa (nama, nim, kelas, jenisKel, hobi, fakultas, alamat, username, pass) VALUES ('$nama','$nim','$kelas','$jenisKel','$tmp_hobi','$fakultas','$alamat', '$username', '$pass')";
